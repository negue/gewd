...
/* harmony import */ var comlink__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! comlink */ 8116);
/* harmony import */ var marked__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! marked */ 997);
/* harmony import */ var marked_highlight__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! marked-highlight */ 3802);
/* harmony import */ var xss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! xss */ 6753);
...
/* harmony import */ var _gewd_lazy_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @gewd/lazy/utils */ 2361);
/* harmony import */ var _gewd_markdown_worker_functions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @gewd/markdown/worker-functions */ 1415);
/* harmony import */ var _gewd_markdown_contracts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @gewd/markdown/contracts */ 4384);
...
const renderer = new marked__WEBPACK_IMPORTED_MODULE_1__.marked.Renderer();
...
const lazyPrism = _gewd_lazy_utils__WEBPACK_IMPORTED_MODULE_4__.Lazy.create(() => __webpack_require__.e(/*! import() */ "node_modules_prismjs_prism_js").then(__webpack_require__.t.bind(__webpack_require__, /*! prismjs */ 9620, 23)));
const lazyEmoji = _gewd_lazy_utils__WEBPACK_IMPORTED_MODULE_4__.Lazy.create(() => __webpack_require__.e(/*! import() */ "libs_markdown_emoji-map_index_ts").then(__webpack_require__.bind(__webpack_require__, /*! @gewd/markdown/emoji-map */ 8366)));
// apply changes to marked
marked__WEBPACK_IMPORTED_MODULE_1__.marked.setOptions({
  // needed for mermaid
  renderer
}).use((0,marked_highlight__WEBPACK_IMPORTED_MODULE_2__.markedHighlight)({
  async: true,
  highlight(code, lang) {
    return (0,_home_runner_work_gewd_gewd_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const highlightedCode = yield (0,_gewd_markdown_worker_functions__WEBPACK_IMPORTED_MODULE_5__.highlightCode)(lazyPrism, lang, code, currentConfigObject.prism, importScripts);
...
const workerMethods = {
  ...
  initPrism(options) {},
  compile: input => new Promise( /*#__PURE__*/function () {
    var _ref = (0,_home_runner_work_gewd_gewd_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
      if (!input) {
        resolve('');
        return;
      }
      if (_gewd_markdown_worker_functions__WEBPACK_IMPORTED_MODULE_5__.emojiRegex.test(input)) {
        ...
        const {
          EMOJI_MAP,
          colonToUnicode
        } = yield lazyEmoji.getValue();
        input = (0,_gewd_markdown_worker_functions__WEBPACK_IMPORTED_MODULE_5__.checkAndReplaceToUnicodeChar)(input, EMOJI_MAP, colonToUnicode);
      }
      const result = yield (0,marked__WEBPACK_IMPORTED_MODULE_1__.marked)(input, {
      ...
      function resolveCleanMarkup(generatedHTML) {
        const sanatizedHTML = xss__WEBPACK_IMPORTED_MODULE_3__.filterXSS(generatedHTML, {
          whiteList: {
            ...xss__WEBPACK_IMPORTED_MODULE_3__.whiteList,
            a: ['class', 'title', 'href'],
            div: ['class'],
  ...
  highlight: (code, lang) => new Promise( /*#__PURE__*/function () {
    var _ref2 = (0,_home_runner_work_gewd_gewd_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resolve, reject) {
      if (!code) {
        resolve('');
        return;
      }
      ...
      (0,_gewd_markdown_worker_functions__WEBPACK_IMPORTED_MODULE_5__.highlightCode)(lazyPrism, lang, code, currentConfigObject.prism, importScripts).then(highlightedCode => {
...
(0,comlink__WEBPACK_IMPORTED_MODULE_7__.expose)(workerMethods);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   checkAndReplaceToUnicodeChar: () => (/* binding */ checkAndReplaceToUnicodeChar),
/* harmony export */   emojiRegex: () => (/* binding */ emojiRegex),
/* harmony export */   mermaidRegex: () => (/* binding */ mermaidRegex)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   checkAndReplaceToUnicodeChar: () => (/* reexport safe */ _public_api__WEBPACK_IMPORTED_MODULE_0__.checkAndReplaceToUnicodeChar),
/* harmony export */   emojiRegex: () => (/* reexport safe */ _public_api__WEBPACK_IMPORTED_MODULE_0__.emojiRegex),
/* harmony export */   get_favicon: () => (/* reexport safe */ _public_api__WEBPACK_IMPORTED_MODULE_0__.get_favicon),
/* harmony export */   highlightCode: () => (/* reexport safe */ _public_api__WEBPACK_IMPORTED_MODULE_0__.highlightCode),
/* harmony export */   linkRendererTargetBlank: () => (/* reexport safe */ _public_api__WEBPACK_IMPORTED_MODULE_0__.linkRendererTargetBlank),
/* harmony export */   linkRendererWithFavIcon: () => (/* reexport safe */ _public_api__WEBPACK_IMPORTED_MODULE_0__.linkRendererWithFavIcon),
/* harmony export */   mermaidRegex: () => (/* reexport safe */ _public_api__WEBPACK_IMPORTED_MODULE_0__.mermaidRegex)
/* harmony export */ });
/* harmony import */ var _public_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./public_api */ 2109);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   get_favicon: () => (/* binding */ get_favicon),
/* harmony export */   linkRendererTargetBlank: () => (/* binding */ linkRendererTargetBlank),
/* harmony export */   linkRendererWithFavIcon: () => (/* binding */ linkRendererWithFavIcon)
/* harmony export */ });
...
function highlightCode(_x, _x2, _x3, _x4, _x5) {
  return _highlightCode.apply(this, arguments);
}
function _highlightCode() {
  _highlightCode = (0,_home_runner_work_gewd_gewd_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (prismInstanceAsync, lang, code, prismOption, importScripts) {
    if (!prismInstance) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   checkAndReplaceToUnicodeChar: () => (/* reexport safe */ _emoji_functions__WEBPACK_IMPORTED_MODULE_0__.checkAndReplaceToUnicodeChar),
/* harmony export */   emojiRegex: () => (/* reexport safe */ _emoji_functions__WEBPACK_IMPORTED_MODULE_0__.emojiRegex),
/* harmony export */   get_favicon: () => (/* reexport safe */ _marked_functions__WEBPACK_IMPORTED_MODULE_2__.get_favicon),
/* harmony export */   highlightCode: () => (/* reexport safe */ _prism_functions__WEBPACK_IMPORTED_MODULE_1__.highlightCode),
/* harmony export */   linkRendererTargetBlank: () => (/* reexport safe */ _marked_functions__WEBPACK_IMPORTED_MODULE_2__.linkRendererTargetBlank),
/* harmony export */   linkRendererWithFavIcon: () => (/* reexport safe */ _marked_functions__WEBPACK_IMPORTED_MODULE_2__.linkRendererWithFavIcon),
/* harmony export */   mermaidRegex: () => (/* reexport safe */ _emoji_functions__WEBPACK_IMPORTED_MODULE_0__.mermaidRegex)
/* harmony export */ });
/* harmony import */ var _emoji_functions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./emoji.functions */ 7306);
/* harmony import */ var _prism_functions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./prism.functions */ 1453);
/* harmony import */ var _marked_functions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./marked.functions */ 2420);
...
var DEFAULT = __webpack_require__(/*! ./default */ 7687);
var parseStyle = __webpack_require__(/*! ./parser */ 4703);
var _ = __webpack_require__(/*! ./util */ 7984);
...
var DEFAULT = __webpack_require__(/*! ./default */ 7687);
var FilterCSS = __webpack_require__(/*! ./css */ 8021);
...
var FilterCSS = (__webpack_require__(/*! cssfilter */ 3230).FilterCSS);
var getDefaultCSSWhiteList = (__webpack_require__(/*! cssfilter */ 3230).getDefaultWhiteList);
var _ = __webpack_require__(/*! ./util */ 7689);
function getDefaultWhiteList() {
  return {
    a: ["target", "href", "title"],
    abbr: ["title"],
...
var DEFAULT = __webpack_require__(/*! ./default */ 9140);
var parser = __webpack_require__(/*! ./parser */ 8158);
var FilterXSS = __webpack_require__(/*! ./xss */ 5051);
...
"use strict";
/*!**********************************************!*\
  !*** ./apps/demo/src/app/markdown.worker.ts ***!
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _gewd_markdown_marked_prism_worker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @gewd/markdown/marked.prism.worker */ 5381);
...
/******/ })()
;
//# sourceMappingURL=apps_demo_src_app_markdown_worker_ts.js.map